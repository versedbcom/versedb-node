...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetCharacterTeamsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/characters/{character_id}/teams")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCharacterTeamsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
