 ...
 */
export function userLendACopyOut(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.LendACopyOutRequest$outboundSchema, value),
  ...
  const pathParams = {
    collectionItem_id: encodeSimple(
      "collectionItem_id",
      payload.collectionItem_id,
      { explode: false, charEncoding: "percent" },
    ),
  };
  const path = pathToFunc("/api/v1/user/collections/{collectionItem_id}/loan")(
    pathParams,
  );
