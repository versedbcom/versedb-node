...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.SaveListRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SaveListResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.json(201, operations.SaveListResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
