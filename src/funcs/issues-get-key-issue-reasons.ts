...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetKeyIssueReasonsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/issues/{issue_id}/key-reasons")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetKeyIssueReasonsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
