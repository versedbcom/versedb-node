...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetSeriesIssuesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/series/{id}/issues")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSeriesIssuesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
