...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetAnEventRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/events/{event_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAnEventResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
