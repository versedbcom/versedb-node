...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetIssueCharactersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/issues/{id}/characters")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIssueCharactersResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
