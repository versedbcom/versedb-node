 ...
 */
export function keyIssueReasonsListKeyIssueReasons(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListKeyIssueReasonsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/key-issue-reasons")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListKeyIssueReasonsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
