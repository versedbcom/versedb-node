 ...
 */
export function listsStopAListUpdatingItself(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.StopAListUpdatingItselfRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/lists/{list_id}/stop-rule")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StopAListUpdatingItselfResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
