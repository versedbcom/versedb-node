 ...
 */
export function comicShopsListComicShops(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListComicShopsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListComicShopsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
