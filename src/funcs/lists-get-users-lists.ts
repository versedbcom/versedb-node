...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetUsersListsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/users/{user_id}/lists")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUsersListsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
