 ...
 */
export function listsBrowseLists(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.BrowseListsRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/api/v1/lists")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BrowseListsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
