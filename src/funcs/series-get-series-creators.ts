...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetSeriesCreatorsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/series/{id}/creators")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSeriesCreatorsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
