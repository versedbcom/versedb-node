...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetCharacterIssuesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/characters/{character_id}/issues")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCharacterIssuesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
