...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetSeriesDetailsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/series/{series_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSeriesDetailsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
