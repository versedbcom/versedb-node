...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetSeriesCharactersRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/series/{id}/characters")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSeriesCharactersResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
