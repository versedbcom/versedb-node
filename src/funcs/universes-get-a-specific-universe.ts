 ...
 */
export function universesGetASpecificUniverse(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetASpecificUniverseRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/universes/{universe_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetASpecificUniverseResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
