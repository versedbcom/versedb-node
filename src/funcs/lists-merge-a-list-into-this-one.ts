...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MergeAListIntoThisOneRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/lists/{list_id}/merge")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MergeAListIntoThisOneResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
