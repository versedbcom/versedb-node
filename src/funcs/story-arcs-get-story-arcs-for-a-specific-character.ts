...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetStoryArcsForASpecificCharacterRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/characters/{character_id}/story-arcs")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.GetStoryArcsForASpecificCharacterResponse$inboundSchema,
    ...
    M.jsonErr(
      429,
      errors
        .GetStoryArcsForASpecificCharacterTooManyRequestsError$inboundSchema,
      { hdrs: true },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
