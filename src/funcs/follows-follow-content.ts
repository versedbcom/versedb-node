 ...
 */
export function followsFollowContent(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.FollowContentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/follow")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.FollowContentResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
