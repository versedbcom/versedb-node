 ...
 */
export function userCollectionsRemoveIssueFromCollection(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.RemoveIssueFromCollectionRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.nil(
      204,
      types$.optional(
        operations.RemoveIssueFromCollectionResponse$inboundSchema,
      ),
      { hdrs: true },
    ),
    M.jsonErr(
