 ...
 * Returns: id, name
 */
export function universesListUniverses(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListUniversesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/universes")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListUniversesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
