 ...
 */
export function podcastsGetASpecificPodcast(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetASpecificPodcastRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/podcasts/{podcast_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetASpecificPodcastResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
