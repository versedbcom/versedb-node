...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetIssueCreatorsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/issues/{id}/creators")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIssueCreatorsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
