...
export function teamsGetIssuesForASpecificTeam(
  ...
  Result<
    operations.GetIssuesForASpecificTeamResponse,
    | errors.GetIssuesForASpecificTeamUnauthorizedError
    | errors.GetIssuesForASpecificTeamTooManyRequestsError
    | VerseDbError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetIssuesForASpecificTeamRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetIssuesForASpecificTeamResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr(
      401,
      errors.GetIssuesForASpecificTeamUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(
      429,
      errors.GetIssuesForASpecificTeamTooManyRequestsError$inboundSchema,
      { hdrs: true },
    ),
    M.fail("4XX"),
    M.fail("5XX"),
