 ...
 */
export function userCollectionsAddIssueToCollection(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.AddIssueToCollectionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/issues/{issue_id}/collection")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.AddIssueToCollectionResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
