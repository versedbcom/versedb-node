...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListReadStatusRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/user/read-status")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListReadStatusResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
