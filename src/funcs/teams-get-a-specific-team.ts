 ...
 */
export function teamsGetASpecificTeam(
  client: VerseDBCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetASpecificTeamRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/v1/teams/{team_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetASpecificTeamResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
