...
* [convertAListToMixed](#convertalisttomixed) - Open a list to any type.
* [stopAListUpdatingItself](#stopalistupdatingitself) - Stop a list updating itself.
...
<!-- UsageSnippet language="typescript" operationID="openAListToAnyType" method="post" path="/api/v1/lists/{list_id}/convert-to-mixed" -->
```typescript
import { VerseDB } from "@versedbcom/sdk";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.OpenAListToAnyTypeRequest](../../models/operations/open-a-list-to-any-type-request.md)                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.OpenAListToAnyTypeResponse](../../models/operations/open-a-list-to-any-type-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="stopAListUpdatingItself" method="post" path="/api/v1/lists/{list_id}/stop-rule" -->
```typescript
import { VerseDB } from "@versedbcom/sdk";
...
async function run() {
  const result = await verseDB.lists.stopAListUpdatingItself({
    listId: 101,
  });
...
```typescript
import { VerseDBCore } from "@versedbcom/sdk/core.js";
import { listsStopAListUpdatingItself } from "@versedbcom/sdk/funcs/lists-stop-a-list-updating-itself.js";
...
async function run() {
  const res = await listsStopAListUpdatingItself(verseDB, {
    listId: 101,
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("listsStopAListUpdatingItself failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.StopAListUpdatingItselfRequest](../../models/operations/stop-a-list-updating-itself-request.md)                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.StopAListUpdatingItselfResponse](../../models/operations/stop-a-list-updating-itself-response.md)\>**
