...
| `status`                                                                                    | *string*                                                                                    | :heavy_minus_sign:                                                                          | Which copies to return: owned, for_sale, sold, or all. Sold copies are excluded by default. | sold                                                                                        |
...
| `seriesId`                                                                                  | *number*                                                                                    | :heavy_minus_sign:                                                                          | Filter to copies of issues in a series.                                                     | 123                                                                                         |
